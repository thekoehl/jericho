/**
 * @fileoverview This script is used to create an infinite scroll effect.
 * This script was reporposed from the following:
 * http://code.google.com/p/galleryplus/
 *
 * <pre>
 * var container = document.body;
 * var infiniteScroll = new jerico.InfiniteScroll(container);
 * // ...
 * infiniteScroll.dispose();
 * </pre>
 *
 * @author gkoehl@gmail.com (Gary Koehl)
 *
 */

goog.provide('jericho.InfiniteScroll');
...
/**
 * The constructor takes a container element
 * as its parameter. The infinite-scroll is created on
 ...
 * @export
 */
jericho.InfiniteScroll = function(containerElement) {
  /**
...
goog.exportSymbol('jericho.InfiniteScroll', jericho.InfiniteScroll);


/**
 * Removes the gallery and its event listeners from the document.
 */
jericho.InfiniteScroll.prototype.dispose = function() {
 ...
 * @const
 */
jericho.InfiniteScroll.Categories = [
  {tag: '', name: 'All'},
 ...
 * @const
 */
jericho.InfiniteScroll.IMAGE_LIST_URL =
    '/jsonp';
 ...
 * @const
 */
jericho.InfiniteScroll.MSG_VIEW_ALBUM = goog.getMsg('View album');
 ...
 * @const
 */
jericho.InfiniteScroll.MSG_THE_END = goog.getMsg('End of gallery');
 ...
 * @const
 */
jericho.InfiniteScroll.MSG_MAX_IMAGES_REACHED =
 ...
 * @const
 */
jericho.InfiniteScroll.MSG_NO_IMAGES =
 ...
 * @const
 */
jericho.InfiniteScroll.MAX_IMAGE_COUNT = 100;
 ...
 * @const
 */
jericho.InfiniteScroll.INITIAL_LOAD_COUNT = 10;
 ...
 * @const
 */
jericho.InfiniteScroll.SCROLL_LOAD_COUNT = 5;
 ...
 * @const
 */
jericho.InfiniteScroll.MAX_IMAGE_SIZE = 935;
 ...
 * @private
 */
jericho.InfiniteScroll.prototype.createGallery_ = function() {
  ...
  this.categories_ = jericho.InfiniteScroll.Categories;
  this.categoryIndex_ = {};
  this.categoryLinks_ = {};
 ...
 * @private
 */
jericho.InfiniteScroll.prototype.getCategoryLink_ = function(category) {
 ...
 * @private
 */
jericho.InfiniteScroll.prototype.setCategoryLink_ = function(category, link) {
 ...
 * @private
 */
jericho.InfiniteScroll.prototype.loadImages_ =
    function(tag, limit, offset, callback) {
  var jsonp = new goog.net.Jsonp(
      new goog.Uri(jericho.InfiniteScroll.IMAGE_LIST_URL));
 ...
 * @private
 */
jericho.InfiniteScroll.prototype.displayImages_ =
    function(imageList) {
  var seen = {};
  var items = [];
  var sz = jericho.InfiniteScroll.MAX_IMAGE_SIZE;
        ...
        goog.dom.createDom('div', {className: 'user-info'},
            ...
            goog.dom.createDom('span', {className: 'album-link'},
                goog.dom.createDom('a',
                    ...
                    jericho.InfiniteScroll.MSG_VIEW_ALBUM)
            ),
 ...
 * @private
 */
jericho.InfiniteScroll.prototype.createCategoryLink_ =
 ...
 * @private
 */
jericho.InfiniteScroll.prototype.getCategoryFragment_ = function(category) {
 ...
 * @private
 */
jericho.InfiniteScroll.prototype.loadCategory_ = function(category) {
  ...
  this.currentOffset_ = jericho.InfiniteScroll.INITIAL_LOAD_COUNT;
  this.loadedOffset_ = 0;
  this.clearGallery_();
  this.loadImageList_(category, jericho.InfiniteScroll.INITIAL_LOAD_COUNT, 0);
 ...
 * @private
 */
jericho.InfiniteScroll.prototype.clearGallery_ = function() {
 ...
 * @private
 */
jericho.InfiniteScroll.prototype.showSpinner_ = function() {
 ...
 * @private
 */
jericho.InfiniteScroll.prototype.hideSpinner_ = function() {
 ...
 * @private
 */
jericho.InfiniteScroll.prototype.loadImageList_ =
 ...
 * @private
 */
jericho.InfiniteScroll.prototype.loadImagesHandler_ =
    function(category, offset, images)
{
  ...
  if (images.length == 0 && offset == 0) {
    this.showEndMessage_(jericho.InfiniteScroll.MSG_NO_IMAGES);
  } else if (this.loadedOffset_ != this.currentOffset_) {
    this.showEndMessage_(jericho.InfiniteScroll.MSG_THE_END);
  }
};
 ...
 * @private
 */
jericho.InfiniteScroll.prototype.showEndMessage_ = function(msg) {
 ...
 * @private
 */
jericho.InfiniteScroll.prototype.handleScroll_ = function(ev) {
 ...
 * @private
 */
jericho.InfiniteScroll.prototype.tryLoadingNextImages_ = function() {
  if (this.currentOffset_ == this.loadedOffset_) {
    var offset = this.currentOffset_;
    if (offset >= jericho.InfiniteScroll.MAX_IMAGE_COUNT) {
      this.showEndMessage_(jericho.InfiniteScroll.MSG_MAX_IMAGES_REACHED);
    } else {
      this.currentOffset_ += jericho.InfiniteScroll.SCROLL_LOAD_COUNT;
      this.loadImageList_(this.currentCategory_,
                          jericho.InfiniteScroll.SCROLL_LOAD_COUNT, offset);
    }
  }
};
